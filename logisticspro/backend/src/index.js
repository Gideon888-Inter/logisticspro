...
const finSeedCustRouter = require('./routes/fin_seed_customers'); // ONE-TIME customer retry
...
app.use('/api/fin-seed',      finSeedRouter);      // ONE-TIME financial seed
app.use('/api/fin-seed-cust', finSeedCustRouter); // ONE-TIME customer retry
