...
export const api = {
  ...
  resetUserPassword: (id, new_password) => request(`/users/${id}/reset-password`, { method: 'POST', body: JSON.stringify({ new_password }) }),
  getUserAccess:     (id) => request(`/users/${id}/access`),
  updateUserAccess:  (id, body) => request(`/users/${id}/access`, { method: 'PATCH', body: JSON.stringify(body) }),
  revertUserRole:    (id, base_role) => request(`/users/${id}/revert-role`, { method: 'POST', body: JSON.stringify({ base_role }) }),
