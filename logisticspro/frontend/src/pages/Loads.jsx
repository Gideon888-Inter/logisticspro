...
// ── Main Loads Page ───────────────────────────────────────────
export default function Loads({ initialLoadNo = null } = {}) {
        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Customer</th><th>From</th><th>To</th><th>KMs Confirmed</th>
              <th>Rate</th><th>Extra Costs</th><th>Total</th><th>Order No</th><th>Status</th>
            </tr>
          </thead>
          <tbody>
            {loading && <tr><td colSpan={14}><div className="loading">Loading…</div></td></tr>}
            {!loading && loads.length === 0 && <tr><td colSpan={14}><div className="empty-state">No loads found</div></td></tr>}
            {!loading && loads.map(l => {
              const extra = Number(loadCosts[l.m_load_no] || 0);
              const tot = Number(l.m_rate || 0) + extra;
              const isOpen = expandedRow === l.m_load_no;
